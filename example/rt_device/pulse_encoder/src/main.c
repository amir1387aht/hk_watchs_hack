...
rt_err_t encoder_example_init(void)
{
    ...
    HAL_PIN_Set(PAD_PA33, GPTIM2_CH2, PIN_PULLUP, 1);*/

    HAL_PIN_Set(PAD_PA44, GPTIM2_CH1, PIN_PULLUP, 1);
    HAL_PIN_Set(PAD_PB48, GPTIM2_CH2, PIN_PULLUP, 1);

    HAL_PIN_Set(PAD_PA46, GPTIM1_CH1, PIN_PULLUP, 1);
    HAL_PIN_Set(PAD_PA47, GPTIM1_CH2, PIN_PULLUP, 1);
